...
func printUsage(writer io.Writer) {
	...
	fmt.Fprintln(writer, "  plan and migrate auto-create missing table transition scaffold files under <schema>/tables/_migrations/<table>/ when tracked table drift is detected")
