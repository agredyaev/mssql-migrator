...
var inputFieldSpecs = []FieldSpec{
	...
	stringField("report-dir", "RM_REPORT_DIR", "", "optional report output directory", func(input *Input) *string { return &input.ReportDir }),
	...
	stringField("update-policy", "RM_UPDATE_POLICY", UpdatePolicyModulesOnly, "existing object update policy", func(input *Input) *string { return &input.UpdatePolicy }),
