...
- `ops/quality/scripts/check_doc_sync.py` — `docs/specs/internals` index vs `module-*.md` files
...
- When adding a new `docs/specs/internals/module-*.md`, add a table row in `docs/specs/internals/README.md` so `check_doc_sync.py` stays green.
