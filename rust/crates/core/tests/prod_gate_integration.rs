//! Prod incremental go/no-go gate (SQL Server). Mirrors Go `TestProdGate_IncrementalPlan`.
//!
//! Run: `make rust-prod-gate` or `RMIG_RUN_SQLSERVER_INTEGRATION=1 cargo test --test prod_gate_integration -- --nocapture`
