...
/// Slim git side row (**ARENA** / **IDX**). Materialize to [`PlannedGit`] at export only (**VIEW**).
...
pub fn materialize_transition_paths(ws: &Workspace, offs: &[StrOff]) -> Vec<crate::domain::SharedStr> {
