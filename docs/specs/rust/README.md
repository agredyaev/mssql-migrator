...
| `db` | plan DB phase and SQL catalog cache | [`module-db.md`](module-db.md) |
...
| `domain` | workspace, owned object and script metadata | [`module-domain.md`](module-domain.md) |
| `cache`, `session` | legacy cache API and `rmigd` RPC | [`module-cache-session.md`](module-cache-session.md) |
