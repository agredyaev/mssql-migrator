...
- Rustdoc Module API: [`crates/core/src/sql_ident.rs`](file://~/.gemini/antigravity/worktrees/mssql-reporting-migrator/analyze-nasa-docs-compliance/crates/core/src/sql_ident.rs)
- Rustdoc Module API: [`crates/core/src/buildinfo/mod.rs`](file://~/.gemini/antigravity/worktrees/mssql-reporting-migrator/analyze-nasa-docs-compliance/crates/core/src/buildinfo/mod.rs)
- Core specs directory index: [`docs/specs/rust/README.md`](file://~/.gemini/antigravity/worktrees/mssql-reporting-migrator/analyze-nasa-docs-compliance/docs/specs/rust/README.md)
